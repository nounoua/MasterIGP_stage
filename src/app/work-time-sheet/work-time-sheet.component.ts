...
import * as XLSX from 'xlsx';//pour l'exportationn xlsx
import { saveAs } from 'file-saver';
const htmlToPdfmake = require('html-to-pdfmake');//pour l'exportation pdf
...
export class WorkTimeSheetComponent implements OnInit {
  ...
  tableTitles: string[] = ['Fullname', 'Team', 'Vacation balance',
    'Total taken Vacation', 'Total Worked Days', 'Total Leave Hours',
    'Off Boarding Date', 'Total Absence Days', 'Total Vacation',
    'Total Pending', 'pending work', 'Hiring date'];
